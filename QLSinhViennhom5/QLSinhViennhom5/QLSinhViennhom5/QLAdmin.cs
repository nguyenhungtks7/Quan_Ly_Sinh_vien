...
namespace QLSinhViennhom5
{
    public partial class QLAdmin : Form
    {
        ...
        SqlCommand command;
        private string sql = "Data Source=DESKTOP-OF-THAN\\SQLEXPRESS;Initial Catalog=QlSinhVien;Integrated Security=True";
        ...
        private void btnthem_Click(object sender, EventArgs e)
        {
            ...
            if (isValid)
            {
                ...
                command.CommandText = "INSERT INTO Login (tk, mk,fullname,mod, state )values ('" + txt_user.Text + "',N'" + HashPassword(txt_pass.Text) + "',N'"+txthoten.Text+ "',1,"+trangthai+")";
        ...
        private void loaddata()
        {
            command = new SqlCommand();
            command.Connection = connection;
            command.CommandText = "Select tk, mk, fullname, state from Login where mod = 1";
